            ...
            <footer className="bg-[#885E3C] text-white py-10 mt-0">
              <div className="max-w-6xl mx-auto px-4 flex flex-col md:flex-row justify-between items-start gap-8">
                ...
                <div className="flex-1 min-w-[220px] flex flex-col gap-3">
                  ...
                  <div className="font-bold text-sm mb-1">{t("footer.address")}</div>
                  ...
                  <div className="flex items-center gap-2 mt-2">
                    ...
                    <span className="font-bold text-sm">{t("footer.contact")}</span>
                  </div>
                  ...
                  <div className="mt-2 flex items-center gap-2">
                    ...
                    <span className="text-xs font-bold">{t("footer.customerSupport")}</span>
                ...
                <div className="flex-1 min-w-[180px] flex flex-col gap-2 mt-8 md:mt-0">
                  <div className="font-bold mb-2">{t("footer.usefulLinks")}</div>
                  <ul className="space-y-2 text-sm">
                    <li><a href="/" className="hover:underline font-bold">• {t("footer.home")}</a></li>
                    <li><a href="/about" className="hover:underline font-bold">• {t("footer.aboutUs")}</a></li>
                    <li><a href="/booking" className="hover:underline font-bold">• {t("footer.flights")}</a></li>
                    <li><a href="/contact" className="hover:underline font-bold">• {t("footer.contactLabel")}</a></li>
                  </ul>
                </div>
                {/* Bloc droite : réseaux sociaux */}
                <div className="flex-1 min-w-[120px] flex flex-col items-start md:items-end gap-3 mt-8 md:mt-0">
                  <div className="font-bold mb-2">{t("footer.joinUs")}</div>
